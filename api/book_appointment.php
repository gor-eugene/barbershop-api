...
function generateAppointmentMsg($to, $sender_email, $purpose, $sender_phone_number, $date, $time) {
					...
					<td class="movableContentContainer bgItem">
						...
						<div class="movableContent">
							<table cellpadding="0" cellspacing="0" border="0" align="center" width="600" class="container">
	                            ...
	                            <tr>
									<td width="100" colspan="1" align="center" style="padding-bottom:10px;padding-top:25px;">
										<div class="contentEditableContainer contentTextEditable">
						                	<div class="contentEditable" align="center" >
						                  		<h2>From</h2>
						                	</div>
	                                ...
	                                <td width="500" colspan="2" align="left" style="padding-bottom:10px;padding-top:25px;">
	                                	<div class="contentEditableContainer contentTextEditable">
						                	<div class="contentEditable" align="center" >
						                  		<h2>' . $sender_email . ' ' . $sender_phone_number . ''. '</h2>
						                	</div>
						              	</div>
	                                </td>
								</tr>
										...
										<div class="contentEditableContainer contentTextEditable">
						                	<div class="contentEditable" align="left" >
						                  		<strong>  </strong> ,
						                  			<br/>
						                  			<br/>' .
						                  			"The person with the above Details has booked an apointment with you on
						                	</div>
						              	</div>
									</td>" .
									'<td width="100">&nbsp;</td>
